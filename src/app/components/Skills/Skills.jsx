        ...
        >
            ...
            <motion.section className="container mx-auto px-4 relative z-10" initial="hidden" animate="visible">
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-bold text-white">Exploring My Skills</h2>
                    <p className="text-xl text-gray-200 mt-4">Transforming your ideas into distinctive web projects.</p>
                </div>
